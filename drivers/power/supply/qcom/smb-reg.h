...
<<<<<<< HEAD
#define ENG_BUCKBOOST_CfG9				(MISC_BASE + 0xC8)
#define ENG_BUCKBOOST_IPEAK_DC_SELECT	GENMASK(5, 3)
#define ENG_BUCKBOOST_IPEAK_USB_SELECT	GENMASK(2, 0)
